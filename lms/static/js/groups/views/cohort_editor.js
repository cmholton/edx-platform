;(function (define) {
    'use strict';
    define(['backbone', 'underscore', 'jquery', 'gettext', 'string_utils', 'js/groups/views/cohort_form', 
            'js/models/notification', 'js/views/notification'],
        function(Backbone, _, $, gettext, interpolate_text, CohortFormView, NotificationModel, NotificationView) {
